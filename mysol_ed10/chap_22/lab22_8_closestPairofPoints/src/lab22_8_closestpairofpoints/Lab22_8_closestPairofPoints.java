 ...
 */
package lab22_8_closestpairofpoints;
...
public class Lab22_8_closestPairofPoints {
     ...
     */
    public Lab22_8_closestPairofPoints(Point2D[] points) {
...
//        int n = StdIn.readInt();
        ...
        Lab22_8_closestPairofPoints closest = new Lab22_8_closestPairofPoints(points);
