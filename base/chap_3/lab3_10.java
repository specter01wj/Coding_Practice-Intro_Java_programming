...
public class lab3_10 {
    ...
    public static void main(String[] args) {
      ...
      int answer = JOptionPane.showConfirmDialog(null, "your DOB in these?\n" + set1);
      if(answer == JOptionPane.YES_OPTION) day += 1;

      answer = JOptionPane.showConfirmDialog(null, "your DOB in these?\n" + set2);
      ...
      JOptionPane.showMessageDialog(null, "your DOB is " + day );
